...
with app.app_context():
    ...
    users = [
        {'username': 'mharamis', 'email': 'mharamis@umd.edu', 'first_name': 'Michael', 'last_name': 'Haramis',
         'password': generate_password_hash('mharamis', method='pbkdf2:sha256'), 'role': 'STUDENT'},
